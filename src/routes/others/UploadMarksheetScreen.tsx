...
const UploadMarksheetScreen = ({
  navigation,
}: NativeStackScreenProps<RootStackParamList, 'UploadMarksheetScreen'>) => {
  return (
    <SafeAreaView style={styles.container}>
      ...
      <CustomKeyboardAvoidingView
        ...
        <View style={{gap: 20, marginTop: 20}}>
          <View>
            <Text style={styles.label}>High School Marksheet</Text>
            <TouchableOpacity
              onPress={async () => {
                try {
          ...
          <View>
            <Text style={styles.label}>Intermediate Marksheet</Text>
            <TouchableOpacity
              onPress={async () => {
                try {
                  const [pickResult] = await pick();
          ...
          <View>
            <Text style={styles.label}>Highest Qual Marksheet</Text>
            <TouchableOpacity
              onPress={async () => {
                try {
                  const [pickResult] = await pick();
