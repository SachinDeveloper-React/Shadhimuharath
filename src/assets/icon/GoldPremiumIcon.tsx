...
const GoldPremiumIcon = (props: Props) => {
  return (
    <Svg width="48" height="47" viewBox="0 0 48 47" fill="none">
      <G filter="url(#filter0_d_6223_1039)">
        ...
        <Rect
          ...
          height="40"
          rx="20"
          fill="url(#paint0_linear_6223_1039)"
          fillOpacity="0.9"
        />
        <Path
      ...
      <Defs>
        <Filter
          ...
          <FeBlend
            ...
            result="effect1_dropShadow_6223_1039"
          />
          <FeBlend
            mode="normal"
            in="SourceGraphic"
            in2="effect1_dropShadow_6223_1039"
            result="shape"
          />
        </Filter>
        <LinearGradient
          id="paint0_linear_6223_1039"
          x1="4"
          y1="20.5"
          x2="32.7109"
          y2="24.641"
...
export default GoldPremiumIcon;
